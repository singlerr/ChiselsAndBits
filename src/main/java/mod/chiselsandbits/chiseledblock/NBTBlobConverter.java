...
public class NBTBlobConverter {
  ...
  public VoxelBlobStateReference getVoxelRef(final int version, final long weight)
      throws Exception {
  ...
  public final void writeChisleData(final CompoundTag compound, final boolean crossWorld) {
    ...
    final int newFormat =
        crossWorld ? VoxelBlob.VERSION_CROSSWORLD : VoxelBlob.VERSION_COMPACT_PALLETED;
