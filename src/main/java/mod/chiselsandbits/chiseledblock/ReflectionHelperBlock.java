...
public class ReflectionHelperBlock extends Block implements IBlockWithWorldlyProperties {
  ...
  public VoxelShape getOcclusionShape(
      @Nullable final BlockState state, @Nullable final BlockGetter worldIn,
  ...
  public VoxelShape getBlockSupportShape(
      @Nullable final BlockState state, @Nullable final BlockGetter reader,
      @Nullable final BlockPos pos) {
    markMethod();
    return Shapes.empty();
  }
  ...
  @Override
  public float getFriction(BlockState state, LevelReader levelReader, BlockPos pos,
  ...
  @Override
  public boolean canHarvestBlock(BlockState state, BlockGetter blockGetter, BlockPos pos,
                                 Player player) {
    markMethod();
    return false;
  }
  ...
  @Override
  public BlockState rotate(BlockState state, LevelAccessor levelAccessor, BlockPos pos,
                           Rotation rotation) {
    markMethod();
    return state;
  }
  ...
  public boolean shouldDisplayFluidOverlay(
      BlockState state, BlockAndTintGetter blockAndTintGetter, BlockPos pos,
  ...
  @Override
  public SoundType getSoundType(BlockState state, LevelReader levelReader, BlockPos pos,
                                @Nullable Entity entity) {
    markMethod();
  ...
  @Override
  public float getExplosionResistance(
      final BlockState state, final BlockGetter world, final BlockPos pos,
