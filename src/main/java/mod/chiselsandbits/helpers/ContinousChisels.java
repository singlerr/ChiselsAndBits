...
public class ContinousChisels implements IContinuousInventory {
  ...
  private final HashMap<Integer, List<ItemStackSlot>> actionCache =
      new HashMap<Integer, List<ItemStackSlot>>();
  ...
  public ContinousChisels(
    ...
    // test can edit...
    canEdit =
        who.canPlayerManipulate(pos, side, new ItemStack(ModItems.ITEM_CHISEL_DIAMOND.get(), 1),
            false);
