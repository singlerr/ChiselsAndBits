...
public class PacketUndo extends ModPacket {
  ...
  public PacketUndo(final BlockPos pos, final VoxelBlobStateReference before,
  ...
  public boolean preformAction(final ActingPlayer player,
      ...
      if (target.equals(bBefore)) {
        ...
        if (successful) {
          if (spawnItemsAndCommitWorldChanges) {
            ...
            BitInventoryFeeder feeder =
                new BitInventoryFeeder(player.getPlayer(), player.getWorld());
