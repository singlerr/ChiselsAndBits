...
public class NetworkChannel {
   ...
   */
  public <MSG extends ModPacket> void registerMessage(final Class<MSG> msgClazz,
    ...
    ServerPlayNetworking.registerGlobalReceiver(
        packetType,
        (packet, player, responseSender) -> packet.processPacket(
            new Context(player, responseSender), true));
  }
