...
public class ChiselsAndBitsClient {
  ...
  public static void onClientInit() {
    ...
    MenuScreens.register(ModContainerTypes.CHISEL_STATION_CONTAINER.get(),
  ...
  public static void registerIconTextures() {
    ...
    if (Minecraft.getInstance()
        .getResourceManager() instanceof ReloadableResourceManager resourceManager) {
  ...
  public static void retrieveRegisteredIconSprites(TextureAtlas map) {
    ...
    ClientSide.placeIcon =
        spriteUploader.getSprite(new ResourceLocation("chiselsandbits", "place"));
    ...
    ClientSide.trashIcon =
        spriteUploader.getSprite(new ResourceLocation("chiselsandbits", "trash"));
