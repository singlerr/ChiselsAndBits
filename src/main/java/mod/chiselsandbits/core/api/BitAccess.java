...
public class BitAccess implements IBitAccess {
  ...
  public BitAccess(final Level worldIn, final BlockPos pos, final VoxelBlob blob,
  ...
  public void commitChanges(final boolean triggerUpdates) {
    ...
    if (w != null && p != null) {
      ...
      if (tile == null
          && (rv =
          BlockChiseled.replaceWithChiseled(w, p, world.getBlockState(p), cb.mostCommonState,
              false))
          .success) {
        tile = rv.te;
      }
