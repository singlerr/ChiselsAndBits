...
public class Configuration {
  ...
  public Configuration() {
    ...
    ForgeConfigRegistry.INSTANCE.register(ChiselsAndBits.MODID, ModConfig.Type.COMMON,
        commonConfigSpec);
    ForgeConfigRegistry.INSTANCE.register(ChiselsAndBits.MODID, ModConfig.Type.CLIENT,
        clientConfigSpec);
    ForgeConfigRegistry.INSTANCE.register(ChiselsAndBits.MODID, ModConfig.Type.SERVER,
        serverConfigSpec);
  }
