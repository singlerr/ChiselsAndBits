...
public final class ModItems {
  ...
  public static final Supplier<ItemBlockChiseled> ITEM_CHISELED_BLOCK =
      Suppliers.memoize(
          () -> new ItemBlockChiseled(ModBlocks.CHISELED_BLOCK.get(), new Item.Properties()));
  ...
  public static final Supplier<ItemChisel> ITEM_CHISEL_NETHERITE =
      Suppliers.memoize(
          () -> new ItemChisel(Tiers.NETHERITE, new Item.Properties().fireResistant()));
  ...
  public static final Supplier<ItemBitSaw> ITEM_BIT_SAW_NETHERITE =
      Suppliers.memoize(
          () -> new ItemBitSaw(Tiers.NETHERITE, new Item.Properties().fireResistant()));
  ...
  public static void onModConstruction() {
    ...
    Registry.register(
        BuiltInRegistries.ITEM, new ResourceLocation(Constants.MOD_ID, "chisel_iron"),
        ITEM_CHISEL_IRON.get());
    Registry.register(
        BuiltInRegistries.ITEM, new ResourceLocation(Constants.MOD_ID, "chisel_gold"),
    ...
    Registry.register(
        BuiltInRegistries.ITEM, new ResourceLocation(Constants.MOD_ID, "block_bit"),
        ITEM_BLOCK_BIT.get());
    Registry.register(
        BuiltInRegistries.ITEM, new ResourceLocation(Constants.MOD_ID, "mirrorprint"),
    ...
    Registry.register(
        BuiltInRegistries.ITEM, new ResourceLocation(Constants.MOD_ID, "bit_bag"),
    ...
    Registry.register(
        BuiltInRegistries.ITEM, new ResourceLocation(Constants.MOD_ID, "wrench_wood"),
        ITEM_WRENCH.get());
    Registry.register(
        BuiltInRegistries.ITEM,
    ...
    Registry.register(
        BuiltInRegistries.ITEM, new ResourceLocation(Constants.MOD_ID, "bitsaw_gold"),
        ITEM_BIT_SAW_GOLD.get());
    Registry.register(
        BuiltInRegistries.ITEM, new ResourceLocation(Constants.MOD_ID, "bitsaw_iron"),
