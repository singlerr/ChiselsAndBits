...
public enum ModRenderTypes {
  ...
  private static class InternalState extends RenderStateShard {
    ...
    private static final DepthTestGreaterOrEqual GREATER_OR_EQUAL_DEPTH_TEST =
        new DepthTestGreaterOrEqual();
  ...
  private static class InternalType extends RenderType {
    private static final RenderType MEASUREMENT_LINES = RenderType.create(
    ...
    private static final RenderType CHISEL_PREVIEW_INSIDE_BLOCKS = RenderType.create(
    ...
    private static final RenderType CHISEL_PREVIEW_OUTSIDE_BLOCKS = RenderType.create(
    ...
    private static final RenderType WIREFRAME_BODY = RenderType.create(
        ...
        CompositeState.builder()
            ...
            .createCompositeState(false));
    private static final TextureStateShard BLOCK_TEXTURE =
        new TextureStateShard(TextureAtlas.LOCATION_BLOCKS, false, false);
    private static final DepthTestStateShard GREATER_DEPTH_TEST =
        new DepthTestStateShard(">", GL11.GL_GREATER);
    ...
    private static final RenderType GHOST_BLOCK_COLORED_PREVIEW_ALWAYS =
        buildColoredGhostType(true);
